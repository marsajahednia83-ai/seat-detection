...
. Training duration: 9 hours of training time limits rapid iteration and hyperparameter tuning. Fixed camera angles The model assumes consistent camera perspectives across deployment. 

. Lighting dependency Extreme lighting conditions (very dark, very bright) may reduce accuracy. Limited seat types The dataset represents specific campus seating; new furniture may require additional training.
